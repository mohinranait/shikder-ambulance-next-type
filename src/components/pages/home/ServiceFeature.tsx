    ...
    <section className="py-10 bg-white dark:bg-black home_category_section ">
      ...
      <div className="container grid lg:grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-justify text-slate-700 font-normal">
            Our courteous and expert professionals recognize the significance of
            both comfort and safety, prioritizing your well-being throughout the
            entire journey. Shikder Ambulance, and allow us to guide you to your
            destination with the most care and precision.
          </p>
          <div className="mt-4">
