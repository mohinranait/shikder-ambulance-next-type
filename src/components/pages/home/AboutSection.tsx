        ...
        <div className="grid grid-cols-1 pt-6 lg:grid-cols-5 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-2  ">
            <div className="p-10 bg-slate-50">
              <h2 className="text-3xl font-bold text-black mb-3">About me</h2>
              <p className="text-gray text-base font-medium">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Similique doloremque amet impedit quidem architecto cumque minus
                provident nesciunt ab aliquam.
              </p>
              <p className="text-gray text-base font-medium">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Similique doloremque amet impedit quidem architecto cumque minus
