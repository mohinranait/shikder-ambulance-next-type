      ...
      <section className="bg-primary">
        <div className="container py-16 ">
          ...
          <p className="text-center text-slate-300">
            ...
            types of Ambulance with Trusted. You can Ambulance booking with 100%
            Trust.
          </p>
      ...
      <section className="py-10">
        <div className="container">
          ...
          <p className="text-center ">
            {" "}
            100% Secure & Trusted Ambulance company{" "}
          </p>
          <div className=" space-y-3 pt-5">
            <div>
              <h3 className="text-base font-bold">
                The privacy policy Online Ambulance
              </h3>
              <p>
                The privacy Policy is strong of online ambulance service company
            ...
            <div>
              <h3 className="text-base font-bold">
                The privacy policy Online Ambulance Company Bangladesh
              </h3>
              <p>
                The privacy Policy is strong of online ambulance service company
                is largest and trusted company. When you visit this sites then
          ...
          <div className=" mt-5">
            <div>
              ...
              <p>
                ...
                voluptatum vitae ratione quaerat beatae amet. Nihil voluptatum
                vitae ratione quaerat beatae amet.
              </p>
